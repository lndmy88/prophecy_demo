...
object Results_Drivers {

  def apply(spark: SparkSession, in0: DataFrame, in1: DataFrame): DataFrame =
    in0
      .as("in0")
      .join(in1.as("in1"),
            col("in1.driver_id") === col("in0.driver_id"),
            "inner"
      )
      .select(
        ...
        col("in1.name").as("driver_name"),
        col("in1.number").as("driver_number"),
        col("in1.nationality").as("driver_nationality")
      )
